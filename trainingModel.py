...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            data = preprocessor.drop_duplicate(data=data)

            # create separate features and labels
            X,Y=preprocessor.separate_label_feature(data,label_column_name='target')
            ...
            X, Y = preprocessor.synthetic_data(X, Y)
            ...
            for i in list_of_clusters:
                ...
                best_model_name,best_model=model_finder.get_best_model(train_x,y_train,test_x,y_test,cluster=i)

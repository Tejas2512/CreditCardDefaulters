...
class Preprocessor:
    ...
    def separate_label_feature(self, data, label_column_name):
        ...
        try:
            ...
            print("exception in saparate labels:: ", data.head())
    ...
    def drop_duplicate(self,data):
        ...
        """
         Method Name: drop_duplicate
        Description: This method remove duplicate raw.
        ...
        try:
            ...
            self.logger_object.log(self.file_object,"drop duplicate records")

            return data

        except Exception as e:
            self.logger_object.log(self.file_object,"Exception:: {} occurred in drop_duplicate method of preprocessor class.")
            raise e

    def synthetic_data(self,x,y):
        ...
        Revisions: None
                                     """
        self.logger_object.log(self.file_object,
                               'Entered the synthetic_data method of the Preprocessor class')

        try:
            self.rdsmple = RandomOverSampler()
            self.x_sampled,self.y_sampled  = self.rdsmple.fit_sample(x,y)
            self.logger_object.log(self.file_object,
                                   'dataset balancing successful. Exited the synthetic_data method of the Preprocessor class')
            return self.x_sampled,self.y_sampled

        except Exception as e:
            self.logger_object.log(self.file_object,
                                   'Exception occured in synthetic_data method of the Preprocessor class. Exception message:  ' + str(e))
            self.logger_object.log(self.file_object,
                                   'dataset balancing Failed. Exited the synthetic_data method of the Preprocessor class')
            raise Exception()
